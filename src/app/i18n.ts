...
export const dictionaries = {
  id: {
    ...
    home: {
      ...
      resetConfirmPrompt: "Apakah anda yakin ingin reset game nya?",
      resetCancel: "TIDAK",
      resetConfirm: "YA, YAKIN",
    ...
    instruction: {
      ...
      imageStepLabels: ["Lihat gambarnya", "Pikirkan namanya", "Jawab dengan bahasa Inggris"],
      arrangeWord: "Susun menjadi kata yang benar",
      arrangeHelper: "Seret / ketuk huruf sesuai urutan agar membentuk kata yang benar",
      checkButtonDemo: "CEK JAWABAN!",
      clickCheck: "Klik tombol cek jawaban!",
      hintRewardTitle: "Kumpulkan hint dari jawaban benar",
      hintRewardHelper: "Hint kamu sudah terbuka! Klik tombol Hint untuk memberikan jawaban!",
      correctAnswerBadge: (count: number) => `Jawaban benar! #${count}`,
      close: "TUTUP",
      play: "MAIN!",
    },
    game: {
  ...
  en: {
    ...
    home: {
      ...
      indonesian: "Indonesia",
      resetGame: "Reset game",
      resetConfirmPrompt: "Are you sure you want to reset the game?",
      resetCancel: "NO",
    ...
    instruction: {
      ...
      imageStepLabels: ["Look at the image", "Think of its name", "Answer in English"],
      arrangeWord: "Arrange into the correct word",
      arrangeHelper: "Drag / tap the letters in order to form the correct word",
      checkButtonDemo: "CHECK ANSWER!",
      clickCheck: "Click the check button!",
      hintRewardTitle: "Collect hints from correct answers",
      hintRewardHelper: "Your hint is unlocked! Tap Hint to reveal an answer!",
      correctAnswerBadge: (count: number) => `Correct answer! #${count}`,
      close: "CLOSE",
      play: "PLAY!",
    },
    game: {
